...
CI runs 9 jobs total: a shared build job, followed by 7 parallel jobs and a summary:
...
| `scaffold-smoke`  | End-to-end scaffold smoke for `cli`, `library`, and `full-stack`                 |
