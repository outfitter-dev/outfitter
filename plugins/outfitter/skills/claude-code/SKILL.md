...
| Creating skills (Claude-specific features) | This skill + `outfitter:skills-dev` for base spec |
| Creating skills (cross-platform spec) | `outfitter:skills-dev` |
...
Claude Code extends the base [Agent Skills specification](https://agentskills.io/specification) with additional features. For the cross-platform spec, load `outfitter:skills-dev`.
