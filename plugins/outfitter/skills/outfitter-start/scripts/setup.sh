...
#
# Scans a codebase and generates an Outfitter adoption plan.
...
OUTPUT_DIR="$AGENTS_DIR/plans/outfitter-start"

echo -e "${BLUE}Outfitter Start${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
if [[ -d "$AGENTS_DIR" ]]; then
  ...
  if [[ -d "$OUTPUT_DIR" ]]; then
    echo -e "${RED}Error:${NC} outfitter-start plan already exists at:"
    echo "  $OUTPUT_DIR"
    echo ""
...
echo ""
echo "Next steps:"
echo "  1. Load the atlas:       /outfitter-atlas"
