...
**Skill**: Use `claude-plugins` audit checklists (see [audit reference](${CLAUDE_PLUGIN_ROOT}/skills/claude-plugins/references/audit.md))
...
Create `artifacts/skill-distillery/audit.md` with findings.
