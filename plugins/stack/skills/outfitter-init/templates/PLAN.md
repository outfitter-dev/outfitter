...
4. Load `outfitter-stack:outfitter-fieldguide` for patterns and templates
...
Then use `outfitter-stack:outfitter-check` for full compliance audit.

## Resources

- [outfitter-fieldguide](outfitter-stack:outfitter-fieldguide) — Patterns and templates
- [outfitter-check](outfitter-stack:outfitter-check) — Compliance verification
