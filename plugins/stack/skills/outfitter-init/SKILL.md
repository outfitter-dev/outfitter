...
1. Load `outfitter-stack:outfitter-fieldguide` — you need it for conversion patterns
...
```
/outfitter-stack:outfitter-check
```
...
- `outfitter-stack:outfitter-fieldguide` — Patterns and templates (load first)
