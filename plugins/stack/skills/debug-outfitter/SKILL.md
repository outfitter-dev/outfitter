...
1. Load the `outfitter-stack:outfitter-fieldguide` skill to gain expertise in the Outfitter packages.
...
6. If the issue is in Outfitter's packages themselves, [escalate](#when-to-escalate) via `outfitter-stack:outfitter-feedback`
...
2. Recommend using `outfitter-stack:outfitter-feedback` skill to file an issue
3. Include reproduction steps and expected vs actual behavior

## Related Skills

- `outfitter-stack:outfitter-fieldguide` — Correct patterns reference
- `outfitter-stack:outfitter-check` — Compliance verification
- `outfitter-stack:outfitter-feedback` — Report issues to Outfitter team
