...
┌─────────────────────────────────────────────────────────────────┐
│  META: @outfitter/stack (version coordination across all tiers) │
└─────────────────────────────────────────────────────────────────┘
```
...
| `@outfitter/stack` | Version coordination meta-package | Ensuring compatible versions |
...
Something not working? Use `outfitter-stack:debug-outfitter` for systematic investigation with structured reports. Common issues:
...
If the issue is in Outfitter itself, use `outfitter-stack:outfitter-feedback` to file a bug.
