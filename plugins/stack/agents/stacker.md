...
|-----------|----------------|----------|
| **Review/Audit** | `outfitter-stack:outfitter-check`, `outfitter-stack:outfitter-fieldguide` | review, audit, check, compliance, validate |
| **Design/Architecture** | `outfitter-stack:outfitter-fieldguide` | design, plan, structure, architecture, handlers |
| **Implement/Build** | `outfitter:tdd`, `outfitter-stack:outfitter-fieldguide` | implement, build, create, add, fix |
| **Debug/Troubleshoot** | `outfitter-stack:debug-outfitter`, `outfitter-stack:outfitter-fieldguide` | debug, troubleshoot, not working, error, issue |
| **Adopt/Migrate** | `outfitter-stack:outfitter-init`, `outfitter-stack:outfitter-fieldguide` | adopt, convert, migrate, upgrade, init |

## Execution Process

1. **Parse the request** — Identify keywords that map to a task type
2. **Load foundation first** — Always read `outfitter-stack:outfitter-fieldguide` into context before other skills
...
**ALWAYS:**
- Load `outfitter-stack:outfitter-fieldguide` before other skills
