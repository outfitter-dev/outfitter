...
- `outfitter-stack:stack-review` → `outfitter-stack:outfitter-check`
- `outfitter-stack:stack-audit` → `outfitter-stack:outfitter-init`
...
Three skills have been consolidated into `outfitter-stack:outfitter-fieldguide`:
...
- **@outfitter/stack**: Added documentation for version coordination meta-package
...
- Added `@outfitter/stack` as meta-package for version coordination
...
- `outfitter-stack:stack-patterns` → `outfitter-stack:outfitter-fieldguide`
- `outfitter-stack:stack-templates` → `outfitter-stack:outfitter-fieldguide`
- `outfitter-stack:stack-architecture` → `outfitter-stack:outfitter-fieldguide`
- `outfitter-stack:stack-debug` → `outfitter-stack:debug-outfitter`
- `outfitter-stack:stack-feedback` → `outfitter-stack:outfitter-feedback`
