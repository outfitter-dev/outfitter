...
- **Bun >= 1.3.10** — Install from [bun.sh](https://bun.sh)
...
The scaffolded projects include sensible defaults. If you're setting up manually, use strict TypeScript, oxlint for linting, and oxfmt for formatting. See the [library preset tsconfig](https://github.com/outfitter-dev/outfitter/blob/main/packages/presets/presets/library/tsconfig.json.template) for recommended compiler options.
