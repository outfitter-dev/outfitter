...
The extensive chalk-based styling for waymark syntax (tags, mentions, properties) is domain-specific. Outfitter provides semantic tokens via `@outfitter/tui/render`; individual CLIs style their domain objects.
...
4. **Integrate with @outfitter/tui/render**: Shape-to-output rendering
