...
import { z } from "zod";
import { serializeError, deserializeError, safeStringify, safeParse } from "../serialization.js";
import {
	ValidationError,
	NotFoundError,
	ConflictError,
...
describe("serializeError()", () => {
	...
	it("includes stack when includeStack: true", () => {
		...
		const hasStack = "stack" in serialized || serialized.context?.stack !== undefined;
