...
import { assertDefined, assertMatches, assertNonEmpty, isNonEmptyArray } from "./index.js";
...
describe("assertMatches", () => {
	...
	it("works with complex predicates", () => {
		...
		const result1 = assertMatches("user@example.com", isValidEmail, "Invalid email");
